...
5. **Evaluation isolation**: package freezing with a verifiable content hash and a scoring path outside the coaching context. Drafted in [deferred/role-separation.md](deferred/role-separation.md); until it exists, every score this skill produces is `coach_scored`.
