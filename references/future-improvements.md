...
7. **Knowledge-type cards**: stop treating factual recall, diagnosis, and judgment as interchangeable scheduler objects.
8. **Work-adjacent reconstruction**: a post-shipping unaided rebuild mode, distinct from this dedicated-practice skill.
